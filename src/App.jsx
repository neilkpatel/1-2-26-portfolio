        ...
        <section id="projects" className="pt-8 pb-16 px-6">
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="mb-12">
              ...
              <h2 className="text-2xl font-bold text-white">Experimental Projects <span className="text-gray-500">— technical explorations</span></h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {experimentalProjects.map((project, index) => (
                <div
                  key={index}
                  className="group relative bg-[#111] rounded-lg border border-gray-800 overflow-hidden hover:border-cyan-500/50 transition-all duration-300"
                >
                  {/* Header */}
                  <div className="bg-[#1a1a1a] border-b border-gray-800 px-4 py-2 flex items-center gap-2">
                    <div className="flex gap-1.5">
                    ...
                    <span className="ml-auto text-xs font-mono text-gray-500">{project.date}</span>
                  </div>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.tags.map((tag, i) => (
                        <span key={i} className="px-2 py-0.5 bg-cyan-500/10 text-cyan-400 text-xs font-mono rounded border border-cyan-500/20">
                          {tag}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="px-5 pb-4 flex gap-3">
                    <button
                      onClick={() => window.open(project.demo, '_blank')}
                      className="flex-1 text-center px-4 py-2 bg-cyan-500/20 text-cyan-400 rounded font-mono text-sm font-medium hover:bg-cyan-500/30 transition-colors cursor-pointer border border-cyan-500/30"
                    >
                      try_it()
                    </button>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-2 border border-gray-700 text-gray-400 rounded font-mono text-sm hover:border-cyan-500 hover:text-cyan-400 transition-colors flex items-center gap-2"
                    >
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        <path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" />
                      </svg>
