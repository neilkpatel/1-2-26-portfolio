        ...
        <section id="projects" className="pt-8 pb-16 px-6">
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-slate-400">Production sites actively used by real users</p>
            </div>
                ...
                >
                  ...
                  <div className="relative h-64 bg-gradient-to-br from-blue-500/20 to-purple-500/20 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1.5 bg-green-500/20 border border-green-500/30 rounded-full text-xs font-medium text-green-400">
                        Live
                      </span>
                    </div>
                  </div>
            ...
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">Experimental Projects</h2>
              <p className="text-slate-400">Personal projects and technical explorations</p>
            </div>
